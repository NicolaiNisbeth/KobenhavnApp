...
public class LocaleUtils {
    ...
    public static Event cloneEvent(Event from, String id){
        return new Event(id, from.getName(), from.getImagepath(), from.getSubtitle(), from.getDescription(),
                from.getParticipants(), from.getPlaygroundName(), from.getDetails(), from.isSyncPending());
    }

    public static Event cloneEvent(Event from, boolean syncPending){
        return new Event(from.getId(), from.getName(), from.getImagepath(), from.getSubtitle(), from.getDescription(),
